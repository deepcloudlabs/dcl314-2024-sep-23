...
const {ibanValidator, tcKimlikNoValidator} = require("./validators");

const EmployeeSchema = new Schema({
    "_id": {
        type: String,
        required: true,
        validate: [ tcKimlikNoValidator, "You must provide a valid identity number"]
    },
    fullname: {
        type: String,
        required: true,
...
const updatableFields = [
    "department", "salary", "iban", "fulltime", "photo", "fullname"
]
const isUpdatableField = (field) => {
...
exports.isUpdatableField = isUpdatableField;
